...
class AnalyzeDocumentTool(SubagentTool):
    ...
    def execute_subagent(
        ...
        if self.orchestrator:
            ...
            LOGGER.warning(
                "analyze_document: orchestrator exists but no executor for sync execution. "
                "Task %s for chunk %s cannot be executed via sync path.",
            ...
            return {
                ...
                "error": "Document analysis requires async execution path. "
